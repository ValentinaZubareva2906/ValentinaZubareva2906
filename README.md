...
### 🚀 Стажировки
|название|организация|год прохождения| кол-во часов | осноные задачи | документ |
|:----:|:-----:|:----:|:-----:|:-----:| :-----:|
|Тренировки по МЛ 4.0|Яндекс|сентябрь, 2025|4 недели|Основы Deep Learning и компьютерного зрения, Анализ визуальной информации в робототехнике. Задача детекции,Обучение с подкреплением, Q‑learning, Deep Q‑learning, Современные методы обучения с подкреплением. Advantage actor critic, RLHF, Генеративные трансформеры для планирования движения| сертификат организаторы пришлют после 21.11.2025, на сайте в списках есть |
